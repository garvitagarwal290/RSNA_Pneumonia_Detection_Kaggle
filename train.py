...
def main(args=None):
    ...
    for fold, (train_ids, val_ids) in enumerate(kfold.split(np.zeros(len(dataset)), dataset.get_all_targetlabels())):
        ...
        #for param in retinanet.backbone.parameters():
        ...
        for epoch_num in range(parser.epochs):
            ...
            print('\nFold: {} | Epoch: {} | Avg Classification loss: {:.3f} | Avg Regression loss: {:.3f} | Avg total loss: {:.3f}'.format(fold+1, epoch_num+1, float(epoch_clsloss), float(epoch_regloss), float(epoch_clsloss+epoch_regloss)))
            ...
            torch.save(retinanet.module, 'retinanet_fold{}_epoch{}.pt'.format(fold+1, epoch_num+1))
