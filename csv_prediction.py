...
def main(args=None):
	...
	dataset_test = CSVDataset(parser.csv_test, class_list=parser.csv_classes, transform=transforms.Compose([v2.Normalize(mean=[0.490, 0.490, 0.490], std=[0.229, 0.229, 0.229]),  v2.Resize(256, antialias=True)]))  
